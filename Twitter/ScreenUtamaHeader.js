...
const AppHeader = () => {
    return(
        <View style={{flex:1, flexDirection:'column'}}>
            <View style={{ height:70, backgroundColor: 'white', width: 400 }}> 
           
            {/* <View style={{ flex: 1, backgroundColor: 'white' }}> */}

                      
                    <Image style={{ width: 40, height: 40, marginLeft: 20, marginTop: 15, borderRadius: 50, borderBottomWidth: 0, alignItems: "center" }} source={require('./image/jerome-polin.png')} />
